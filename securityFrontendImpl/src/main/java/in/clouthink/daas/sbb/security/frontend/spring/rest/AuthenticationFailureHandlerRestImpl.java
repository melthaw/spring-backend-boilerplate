package in.clouthink.daas.sbb.security.frontend.spring.rest;

import in.clouthink.daas.sbb.audit.service.AuthEventService;
import in.clouthink.daas.sbb.security.frontend.spring.AuthEventHelper;
...
public class AuthenticationFailureHandlerRestImpl implements AuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request,
		...
		try {
			authEventService.saveUserAuthEvent(AuthEventHelper.buildFailedAuthEvent(request, exception));
		}
		catch (Throwable e) {
			//do nothing
		}
